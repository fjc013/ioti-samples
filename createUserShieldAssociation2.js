...
var userShield = {
  "shieldUUID": "26", // 1 is a predefined water leak shield in the database. You can also use the ID from createShield.js
  "username": "user2", // user id must exist ( see createUser.js)
